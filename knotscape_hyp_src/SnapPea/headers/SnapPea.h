...
/*
 *  The members start_cusp_index, end_cusp_index, start_intercusp_distance,
 *  middle_intercusp_distance, end_intercusp_distance of the structure
 *  CuspNbhdSegment were added by MBT.
 */
...
typedef struct
{
	...
	int		start_index,
			...
			end_index,
                        start_cusp_index,
                        end_cusp_index;
        double          start_intercusp_distance,
                        middle_intercusp_distance,
                        end_intercusp_distance;
} CuspNbhdSegment;
...
extern FuncResult compute_isometries(
								...
								Triangulation	*manifold1,
                                                                Triangulation	**canonical_triangulation,
