 ...
 *
 *	in fprintf() calls, presumably because floats are automatically
 *	promoted to doubles in function parameters.  I'm away from home
 *	as I write this -- I'll have to check this in K&R when I return.
 *	In the meantime, I've changed "%lf" to "%f" in all fprintf() calls.
