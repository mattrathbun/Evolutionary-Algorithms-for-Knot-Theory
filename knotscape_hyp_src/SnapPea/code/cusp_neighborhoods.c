			...
			for (h = 0; h < 2; h++)		/* h = right_handed, left_handed */
			{
				...
				for (f = 0; f < 4; f++)
				{
					...
					next_segment->end_index		= tet->edge_class[edge_between_vertices[v][remaining_face[v][f]]]->index;
                                        next_segment->start_intercusp_distance	= tet->edge_class[edge_between_vertices[v][remaining_face[f][v]]]->intercusp_distance;
					next_segment->middle_intercusp_distance	= tet->edge_class[edge_between_faces[v][f]]->intercusp_distance;
					next_segment->end_intercusp_distance	= tet->edge_class[edge_between_vertices[v][remaining_face[v][f]]]->intercusp_distance;
                                        next_segment->start_cusp_index  = (tet->cusp[remaining_face[f][v]])->index;
                                        next_segment->end_cusp_index    = (tet->cusp[remaining_face[v][f]])->index;
