...
#PBS -o TestKeplerOutput.txt #name of the final output file (whatever you like)
...
mpirun -np 1 -hostfile $PBS_NODEFILE /share/apps/python-2.7.8/bin/python < checkUnknottingNumberDetection.py| tee output.txt
