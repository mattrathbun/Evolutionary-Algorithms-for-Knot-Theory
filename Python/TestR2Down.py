...
print K.to_list()
# Should be [4, 2], [1, 1]
if K != ADTLink.ADTLink([4, 2], [1, 1]):
	raise TypeError("Not the right result!")
print "\n"

L = ADTLink.ADTLink([4, -6, -8, -2], [1, 1, -1, 1])
L1 = L.copy()
L2 = L.copy()
print "L1 and L2 are:"
print L.to_list()
...
print L2.to_list()
# Should be [-2, -4], [1, 1]
if L2 != ADTLink.ADTLink([-2, -4], [1, 1]):
	raise TypeError("Not the right result!")
print "\n"
	
M = ADTLink.ADTLink([6, 8, -2, 4], [-1, 1, 1, 1])
print "M is:"
print M.to_list()
print "\n"
...
print M.to_list()
# Should be [4, 2], [1, 1]
if M != ADTLink.ADTLink([4, 2], [1, 1]):
	raise TypeError("Not the right result!")
print "\n"

N = ADTLink.ADTLink([-4, 6, -8, -2], [1, 1, 1, -1])
print "N is:"
print N.to_list()
print "\n"
